...
the number of predicted daily deaths due to the covid-19 in Finland as of March 17 2021.
In the graph, black line: the number of daily deaths, blue line: predicted curve using 360 days based on 10th degree polynomial curve-fitting, red line changing the number of days　from 100 to 360 days from March 17 2021 based on 5th degree polynomial curve-fitting.

<img src='finland.gif' height=400 width=600>
