...
the number of predicted daily deaths due to the covid-19 in Finland as of March 8 2021.
In the graph, black line: the number of daily deaths, blue line: predicted curve using 340 days based on 10th degree polynomial curve-fitting, red line changing the number of days　from 100 to 340 days from March 8 2021 based on 5th degree polynomial curve-fitting.
